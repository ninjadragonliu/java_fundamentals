...
public class BlackjackController {
    ...
    public static void playBlackjack() {
        ...
        while (player.potValue > 0 && computer.potValue > 0) {
            ...
            // Computer places a random bet (between 1 and its current pot value)
            int computerBet = random.nextInt(computer.potValue) + 1; // Random bet from 1 to computer's current pot value
